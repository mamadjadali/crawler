...
- [x] List View
- [x] Sort from Lowest Price in Sheet
- [x] Abillity to crawl all products at once in a category and Brand
- [x] Product Card Lowest Price -> Who?
...
- [x] mobile140 --> Cheerio
- [x] farnaa --> Cheerio
- [x] kasrapars (needs handaling) []
- [x] technolife --> Puppeteer
- [x] gooshi online --> Cheerio
- [x] zitro --> Cheerio
- [x] Yaran --> Puppeteer
